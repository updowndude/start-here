...
/***/ function(module, exports, __webpack_require__) {
	...
	var _layoutRouter = __webpack_require__(1);

	var _layoutRouter2 = _interopRequireDefault(_layoutRouter);

	var _thanks = __webpack_require__(229);
	...
	switch (document.title) {
		case 'Home':
			ReactDOM.render(React.createElement(_nav2.default, null), document.getElementById('navStuff'));
			ReactDOM.render(React.createElement(_layoutRouter2.default, null), document.getElementById('indexStuff'));
			break;
		case 'Thank you':
			ReactDOM.render(React.createElement(_thanks2.default, null), document.getElementById('thankStuff'));
			break;
		default:
			break;
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _game = __webpack_require__(224);
	...
	var _programming = __webpack_require__(226);

	var _programming2 = _interopRequireDefault(_programming);

	var _reverse = __webpack_require__(227);

	var _reverse2 = _interopRequireDefault(_reverse);

	var _tools = __webpack_require__(228);
	...
	var MyAbout = function (_React$Component) {
		_inherits(MyAbout, _React$Component);

		function MyAbout() {
			_classCallCheck(this, MyAbout);

			return _possibleConstructorReturn(this, Object.getPrototypeOf(MyAbout).apply(this, arguments));
		}

		_createClass(MyAbout, [{
			key: 'render',
			value: function render() {
				return React.createElement(_about2.default, { img: 'images/me.jpg' });
			}
		}]);
	...
	var MyHome = function (_React$Component2) {
		_inherits(MyHome, _React$Component2);

		function MyHome() {
			_classCallCheck(this, MyHome);

			return _possibleConstructorReturn(this, Object.getPrototypeOf(MyHome).apply(this, arguments));
		}
		...
		_createClass(MyHome, [{
			...
			value: function render() {
				return(
					...
					React.createElement(_home2.default, { img: 'images/fm.png', location: 'https://github.com/updowndude/start-here' })
				);
			}
		}]);
	...
	var LayoutRoouter = function (_React$Component3) {
		_inherits(LayoutRoouter, _React$Component3);

		function LayoutRoouter() {
			_classCallCheck(this, LayoutRoouter);

			return _possibleConstructorReturn(this, Object.getPrototypeOf(LayoutRoouter).apply(this, arguments));
		}

		_createClass(LayoutRoouter, [{
			key: 'render',
			value: function render() {
				return React.createElement(
					_reactRouter.Router,
					{ history: _reactRouter.browserHistory },
					React.createElement(_reactRouter.Route, { path: '/', component: MyHome }),
					React.createElement(_reactRouter.Route, { path: '/about', component: MyAbout }),
					React.createElement(_reactRouter.Route, { path: '/game', component: _game2.default }),
					React.createElement(_reactRouter.Route, { path: '/form', component: _form2.default }),
					React.createElement(_reactRouter.Route, { path: '/programming', component: _programming2.default }),
					React.createElement(_reactRouter.Route, { path: '/reverse', component: _reverse2.default }),
					React.createElement(_reactRouter.Route, { path: '/tools', component: _tools2.default })
				);
			}
		}]);

		return LayoutRoouter;
	}(React.Component);

	exports.default = LayoutRoouter;
	...
	var About = function (_React$Component) {
		...
		_createClass(About, [{
			...
			value: function render() {
				...
				return React.createElement(
					'article',
					{ id: 'reactAbout', className: 'pageContent' },
					React.createElement(_test2.default, { title: 'About' }),
					React.createElement(
						'p',
						null,
...
/***/ function(module, exports) {
	...
	var Header = function (_React$Component) {
		...
		_createClass(Header, [{
			key: 'render',
			value: function render() {
				var fontStyle = this.context.fontStyle;
	...
	var Form = function (_React$Component) {
		...
		_createClass(Form, [{
			...
			value: function render() {
				return React.createElement(
					"article",
					{ id: "reactForm", className: "pageContent" },
					React.createElement(_test2.default, { title: "Form" })
				);
			}
		}]);
	...
	var Game = function (_React$Component) {
		...
		_createClass(Game, [{
			...
			value: function render() {
				return React.createElement(
					"article",
					{ id: "reactGame", className: "pageContent" },
					React.createElement(_test2.default, { title: "Game" })
				);
			}
		}]);
		...
		_createClass(Home, [{
			...
			value: function _threeMaker() {
				...
				function setup() {
					...
					var homeThree = document.getElementById('homeThree');
					...
					var maper = loader.load('images/shape2.png');
					...
					var hemisphereLight = new THREE.HemisphereLight(0xf75c5c, 0x000000, 2.03);
					...
					var spotLight2 = new THREE.SpotLight(0xffffff, 0.1);
			...
			value: function render() {
				...
				return React.createElement(
					'article',
					{ id: 'reactHome', className: 'pageContent' },
					React.createElement(
						'h1',
						null,
						'Home'
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Programming = function (_React$Component) {
		_inherits(Programming, _React$Component);

		function Programming() {
			_classCallCheck(this, Programming);

			return _possibleConstructorReturn(this, Object.getPrototypeOf(Programming).apply(this, arguments));
		}

		_createClass(Programming, [{
			key: "render",
			value: function render() {
				return React.createElement(
					"article",
					{ id: "reactProgramming", className: "pageContent" },
					React.createElement(_test2.default, { title: "Programming Map" }),
					React.createElement(
						"div",
						{ className: "programmingNode" },
						React.createElement(
							"h2",
							null,
							"Server"
						...
						React.createElement(
							"svg",
							{ className: "left" },
							React.createElement("line", { x1: "50", y1: "200", x2: "300", y2: "200" }),
							React.createElement("line", { x1: "50", y1: "200", x2: "300", y2: "200" }),
							React.createElement("line", { x1: "50", y1: "200", x2: "300", y2: "200" })
						)
					),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Reverse = function (_React$Component) {
		_inherits(Reverse, _React$Component);

		function Reverse() {
			_classCallCheck(this, Reverse);

			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Reverse).call(this));

			_this._deleteMyText.bind(_this);
			_this._saveMyText.bind(_this);
			_this._loadMyText.bind(_this);
			_this._changeNumber.bind(_this);
			_this.state = {
				works: true,
				limit: 0,
				worksSave: true,
		...
		_createClass(Reverse, [{
			...
			key: '_loadMyText',
			value: function _loadMyText() {
				var myCookie = findMyCookie('speack');
				document.querySelector('.mdl-textfield__input').value = myCookie.substring(myCookie.indexOf('=') + 1);
			}
		}, {
			key: '_changeNumber',
			value: function _changeNumber() {
				var charNum = document.querySelector('.mdl-textfield__input').value.length;
				var charVal = document.querySelector('#charVal');
			...
			value: function render() {
				...
				var worksSave = _state.worksSave;
				var worksClear = _state.worksClear;
				var worksSpeack = _state.worksSpeack;


				return React.createElement(
					'article',
					{ id: 'reactReverse', className: 'pageContent' },
					React.createElement(_test2.default, { title: 'Reverse' }),
					React.createElement('textarea', { onInput: this._changeNumber.bind(this), className: 'mdl-textfield__input', placeholder: 'Enter some text', rows: '20', cols: '100' }),
					React.createElement(
						'div',
						{ id: 'wrapper' },
						React.createElement(
							'button',
							{ id: 'demo-menu-top-right', className: 'mdl-button mdl-js-button mdl-button--icon' },
							React.createElement(
								'i',
						...
						React.createElement(
							'ul',
							{ className: 'mdl-menu mdl-menu--top-right mdl-js-menu mdl-js-ripple-effect', 'data-mdl-for': 'demo-menu-top-right' },
							React.createElement(
								'li',
								{ disabled: worksSpeack, className: 'mdl-menu__item' },
								'Speak'
							),
							React.createElement(
								'li',
								{ disabled: worksClear, className: 'mdl-menu__item', onClick: this._deleteMyText.bind(this) },
								'Clear'
							),
							React.createElement(
								'li',
								{ disabled: worksSave, className: 'mdl-menu__item', onClick: this._saveMyText.bind(this) },
								'Save'
							),
							React.createElement(
								'li',
								{ disabled: works, className: 'mdl-menu__item', onClick: this._loadMyText },
								'Load'
							)
						)
					),
	...
	var Tools = function (_React$Component) {
		...
		_createClass(Tools, [{
			...
			value: function render() {
				return React.createElement(
					"article",
					{ id: "reactTools", className: "pageContent" },
					React.createElement(_test2.default, { title: "Tools" }),
					React.createElement(
						"ul",
...
/***/ function(module, exports) {
	...
	var Thanks = function (_React$Component) {
		...
		function Thanks() {
			...
			return _possibleConstructorReturn(this, Object.getPrototypeOf(Thanks).apply(this, arguments));
		}
		...
		_createClass(Thanks, [{
			...
			value: function render() {
				return React.createElement(
					"article",
					{ id: "reactThank", className: "pageContent" },
					React.createElement(
						"h1",
						null,
						"Thank you"
		...
		_createClass(Nav, [{
			...
			value: function render() {
				return React.createElement(
						...
						React.createElement(
							...
							React.createElement(
								...
								React.createElement(
									...
									React.createElement("img", { src: "images/shape.png", alt: "Shape" }),
									React.createElement(
										"p",
										{ className: "navP" },
										React.createElement(
					...
					React.createElement(
						"button",
						{ className: "mdl-button mdl-js-button mdl-button--fab mdl-button--colored", id: "home" },
						React.createElement(
							"i",
							{ className: "material-icons" },
							React.createElement(
